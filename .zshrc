...
function conda_init(){
__conda_setup="$('/home/leus/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/leus/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/leus/anaconda3/etc/profile.d/conda.sh"
    else
